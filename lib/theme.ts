...
export const ACCENT = '#ff4f7b'

// Derived from ACCENT — adjust opacity as needed
export const ACCENT_DIM = 'rgba(255,79,123,0.13)'
export const ACCENT_BORDER = 'rgba(255,79,123,0.35)'
export const ACCENT_GLOW = 'rgba(255,79,123,0.28)'
// Text color on dark background using accent tone
export const ACCENT_LIGHT = '#ff9bb5'

// ── Backgrounds ───────────────────────────────────────────────────────────────
export const BG = '#09070b'
