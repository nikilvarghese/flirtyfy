...
import { FlirtyfyProvider } from '@/store/flirtyfyStore'
...
function RootLayout() {
  ...
  // Default to authenticated and onboarding completed to remove login function
                    ...
                    <View style={{ flex: 1, backgroundColor: BG }}>
                      <Stack ref={navigationRef} screenOptions={{ headerShown: false, animation: 'fade', contentStyle: { backgroundColor: BG } }}>
                        ...
                        {/* <Stack.Protected guard={!!isAuthed && onboardingCompleted === true}> */}
                          ...
                          <Stack.Screen name="chat-paste" />
                          <Stack.Screen name="ocr-upload" />
